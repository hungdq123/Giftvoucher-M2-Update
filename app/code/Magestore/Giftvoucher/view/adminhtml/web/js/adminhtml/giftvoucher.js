...
//    }
    ...
    validateInputRange = function(el, from, to, priceFormat) {
        ...
        jQuery("#product_composite_configure_input_qty").attr('price', el.value);
    }
    setAmountRange = function(amount) {
        ...
        console.log(amount);
        jQuery("#product_composite_configure_input_qty").attr('price', amount);
    }
    setAmountDropDown = function(el) {
        console.log(el.value);
        var input_hidden = '<input id="abc" type="hidden" value="1" price="'+el.value+'" qtyid="product_composite_configure_input_qty">';
        jQuery("#abc").remove();
        jQuery("#catalog_product_composite_configure_fields_giftvoucher").append(input_hidden);
        console.log(el.value);
    }
})
