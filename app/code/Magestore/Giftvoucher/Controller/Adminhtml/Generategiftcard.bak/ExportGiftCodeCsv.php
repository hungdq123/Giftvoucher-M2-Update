...
/**
 * Adminhtml Generategiftcard ExportGiftcodeCsv Action
 *
 * @category Magestore
 * @package  Magestore_Giftvoucher
 * @module   Giftvoucher
 ...
 */
class ExportGiftCodeCsv extends \Magento\Backend\App\Action
{
    ...
    {
        $fileName = 'generatetemplate_' .date('Y-m-d_H-i-s') . '.csv';
